...
{
    public class MaterializingInMemoryModelSource : InMemoryModelSource
    {
        public MaterializingInMemoryModelSource(IDbSetFinder setFinder, ICoreConventionSetBuilder coreConventionSetBuilder, IModelCustomizer modelCustomizer, IModelCacheKeyFactory modelCacheKeyFactory)
