...
{
    public static class LazySqlServerEntityFrameworkServicesBuilderExtensions
    {
         public static EntityFrameworkServicesBuilder AddSqlServerLazy(this EntityFrameworkServicesBuilder builder)
        {
